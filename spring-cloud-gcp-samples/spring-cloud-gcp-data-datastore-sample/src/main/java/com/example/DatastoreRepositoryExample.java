...
public class DatastoreRepositoryExample {
	...
	public CommandLineRunner commandLineRunner() {
		return args -> {
			...
			this.singerRepository
					.save(new Singer("singer1", "John", "Doe", Collections.emptySet()));
			...
			Singer scottSmith = new Singer("singer3", "Scott", "Smith",
					Collections.singleton(new Album("c", LocalDate.of(2000, Month.AUGUST, 31))));
	...
	public DatastoreCustomConversions datastoreCustomConversions() {
		return new DatastoreCustomConversions(Arrays.asList(
				// Converter to read Set (List to Set)
				// Note that you don't need a Set to List converter
				ConvertersExample.LIST_SET_CONVERTER,
