...
public class TestMessageHandler implements  MessageHandler {
	...
	public void handleMessage(Message<?> message) throws MessagingException {
		...
		ConvertedBasicAcknowledgeablePubsubMessage originalMessage =
				(ConvertedBasicAcknowledgeablePubsubMessage) message.getHeaders().get(GcpPubSubHeaders.ORIGINAL_MESSAGE);
		originalMessage.ack();
	}
}
